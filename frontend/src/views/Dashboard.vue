  ...
  <div class="space-y-6">
    ...
    <div v-else-if="activeWidgets.length === 0" class="text-center py-12">
      ...
      <p class="text-muted-foreground max-w-sm mx-auto mt-2">
        No active widgets found. Please run the database seeder to initialize the dashboard.
      </p>
      <div class="mt-4 p-4 bg-muted/50 rounded-lg font-mono text-xs inline-block text-left">
