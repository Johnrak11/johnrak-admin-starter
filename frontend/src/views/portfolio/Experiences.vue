      ...
      <template #header>
        <div class="flex items-center justify-between">
          <div>
            ...
            <div class="text-sm text-muted-foreground">Add / edit your experiences.</div>
          </div>
    ...
    >
      <div class="w-full max-w-2xl rounded-2xl border border-border bg-card p-4 text-card-foreground shadow-lg">
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="space-y-2">
              <Label>Title</Label>
              <Input v-model="draft.title" type="text" placeholder="Software Engineer" />
            </div>
          <div class="space-y-2">
              <Label>Location</Label>
              <Input v-model="draft.location" type="text" placeholder="Phnom Penh" />
            </div>
          <div class="space-y-2">
              <Label>Employment Type</Label>
              <Input v-model="draft.employment_type" type="text" placeholder="Full-time" />
            </div>
          <div class="space-y-2">
